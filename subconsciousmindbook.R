setwd("E:\\Assignment\\1.solved assignments\\Text Mining")
library(rvest)
library(XML)
library(magrittr)
...
x = readLines("E:\\Assignment\\1.solved assignments\\Text Mining\\subconsciousmindbook.txt") 	# first, read-in data from "amazon subcoscious mind book reviews.txt"
